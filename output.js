//Mon Mar 23 2026 15:40:16 GMT+0000 (Coordinated Universal Time)
...
function getTasksToExecute() {
  ...
  return _0x573718.includes("search") && _0x996fee.push("search"), _0x573718.includes("look") && _0x996fee.push("look"), console.log("从Task环境变量中解析到要执行的任务: " + _0x996fee.join(", ")), _0x996fee;
}
function getAccountConfigsFromEnv() {
  ...
  return console.log("从ksjsck及ksjsck1到ksjsck666环境变量中解析到 " + _0x47e8f6.length + " 个唯一配置"), _0x47e8f6;
}
      ...
      try {
        ...
        if (_0x193b49) {
          ...
          if (_0x4fbdf9 && isValidIP(_0x4fbdf9)) {
            return console.log("✅ " + _0x3b0bb1 + " 代理测试成功，出口IP: " + _0x4fbdf9), {
              "ok": true,
...
class KuaishouAdTask {
  ...
  async ["checkCoinLimit"]() {
    try {
      ...
      return console.log("账号[" + this.nickname + "]" + (this.remark ? "（" + this.remark + "）" : "") + " 金币检查异常: " + _0x4a334d.message), false;
    }
  }
  ["extractCookieInfo"]() {
    try {
  ...
  async ["getAdInfo"](_0x585454) {
    try {
      ...
      if (!_0xbebaef) {
        return console.log("❌ 账号[" + this.nickname + "] 获取 encsign 失败，无法获取广告"), null;
      }
      ...
      return console.log("⚠️ 账号[" + this.nickname + "]" + (this.remark ? "（" + this.remark + "）" : "") + " 获取广告失败: " + (_0x55aabe.errorMsg || JSON.stringify(_0x55aabe).substring(0, 50)) + "..."), null;
    } catch (_0x307dce) {
      return console.log("❌ 账号[" + this.nickname + "]" + (this.remark ? "（" + this.remark + "）" : "") + " 获取广告异常: " + _0x307dce.message), null;
    }
  }
  async ["generateSignature"](_0xd82aa3, _0x4571d8, _0x6b1e39, _0x4b30b4) {
    try {
      ...
      return console.log("❌ 账号[" + this.nickname + "]" + (this.remark ? "（" + this.remark + "）" : "") + " 生成签名异常: " + _0x3555d6.message), null;
    }
  }
  async ["submitReport"](_0x510195, _0x21625f, _0x47dd38, _0x170864, _0x3e085f, _0x2349ed, _0x5cc254) {
    try {
      ...
      if (_0x43bd62.result === 1) {
        ...
        return console.log("💰 账号[" + this.nickname + "]" + (this.remark ? "（" + this.remark + "）" : "") + " " + _0x5cc254.name + "获得" + _0x21be36 + "金币奖励！"), _0x21be36 <= this.lowRewardThreshold ? (this.lowRewardStreak++, this.did = generateKuaishouDid(), console.log("⚠️ 账号[" + this.nickname + "]" + (this.remark ? "（" + this.remark + "）" : "") + " 金币奖励(" + _0x21be36 + ")低于阈值(" + this.lowRewardThreshold + ")，当前连续低奖励次数：" + this.lowRewardStreak + "/" + this.lowRewardLimit), this.lowRewardStreak >= this.lowRewardLimit && (console.log("🏁 账号[" + this.nickname + "]" + (this.remark ? "（" + this.remark + "）" : "") + " 连续" + this.lowRewardLimit + "次奖励≤" + this.lowRewardThreshold + "，停止全部任务"), this.stopAllTasks = true)) : this.lowRewardStreak = 0, {
          "success": true,
          "reward": _0x21be36
        };
      }
      ...
      return console.log("❌ 账号[" + this.nickname + "]" + (this.remark ? "（" + this.remark + "）" : "") + " " + _0x5cc254.name + " 奖励失败，result=" + _0x43bd62.result + " msg=" + (_0x43bd62.data || "")), {
        "success": false,
        "reward": 0
      };
    } catch (_0x53f77b) {
      return console.log("❌ 账号[" + this.nickname + "]" + (this.remark ? "（" + this.remark + "）" : "") + " 提交任务异常: " + _0x53f77b.message), {
        "success": false,
        "reward": 0
      };
    }
  ...
  async ["getSign"](_0x5cbead) {
    try {
      ...
      return console.log("❌ 账号[" + this.nickname + "] encsign 签名服务失败: " + (_0x27bfae?.["message"] || "无响应")), null;
    } catch (_0x12e03e) {
      return console.log("❌ 账号[" + this.nickname + "] encsign 签名请求异常: " + _0x12e03e.message), null;
    }
  }
  async ["requestSignService"](_0x15c908, _0x416a2c) {
    ...
    if (_0x16bd8c && _0x16bd8c.data) {
      ...
      return Object.assign(_0x3a1a6b, {
        "__NS_sig3": _0x225b00,
    ...
    return console.log("❌ 账号[" + this.nickname + "]" + (this.remark ? "（" + this.remark + "）" : "") + " 签名服务失败: " + (_0x16bd8c?.["error"] || _0x16bd8c?.["message"] || "无响应")), null;
  }
  async ["executeTask"](_0x1a0633) {
    ...
    try {
      ...
      if (!_0x180595) {
        return this.taskStats[_0x1a0633].failed++, false;
      }
      ...
      if (_0x32d380?.["success"]) {
        return this.taskStats[_0x1a0633].success++, this.taskStats[_0x1a0633].totalReward += _0x32d380.reward || 0, true;
      }
      return this.taskStats[_0x1a0633].failed++, false;
    } catch (_0x14a987) {
      return console.log("❌ 账号[" + this.nickname + "]" + (this.remark ? "（" + this.remark + "）" : "") + " 任务异常(" + _0x1a0633 + "): " + _0x14a987.message), this.taskStats[_0x1a0633].failed++, false;
    }
  }
...
function loadAccountsFromEnv() {
  ...
  return _0xf7f826.forEach((_0x100c67, _0x4cd7c2) => {
...
async function concurrentExecute(_0x19ef13, _0x176f72, _0x225452) {
  ...
  return await Promise.all(_0x2cf79f), _0x1c70a8;
}
async function processAccount(_0x1e1e8c) {
  ...
  return _0x87003d.printTaskStats(), {
    "index": _0x1e1e8c.index,
    "remark": _0x1e1e8c.remark || "无备注",
    "nickname": _0x3bdc22,
...
function loadAccountsFromEnv() {
  ...
  return _0x254514.forEach((_0x36b2c4, _0x2d36ce) => {
...
async function concurrentExecute(_0x10fd62, _0xcc31d3, _0x53db29) {
  ...
  return await Promise.all(_0x21f9b9), _0x44a305;
}
async function processAccount(_0x4519c9) {
  ...
  return _0x120fcf.printTaskStats(), {
    "index": _0x4519c9.index,
    "remark": _0x4519c9.remark || "无备注",
    "nickname": _0x40dbac,
